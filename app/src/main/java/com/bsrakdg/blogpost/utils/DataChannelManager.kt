...
// like base view model : handle state events, building channels, settings the flow to the channel,
// handling messaging stack, handling state event stack
@FlowPreview
@ExperimentalCoroutinesApi
abstract class DataChannelManager<ViewState> {

    private val _activeStateEvents: HashSet<String> = HashSet() // each state event is unique
